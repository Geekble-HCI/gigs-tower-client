...
# GIGS Game Client - Burger Auto Start Script
# 헬시 버거 챌린지 자동 시작 스크립트
...
while true; do
    ...
    python3 pop-client.py --tcp --type $GAME_TYPE --device_id $DEVICE_ID 2>&1 | tee -a $LOG_FILE
